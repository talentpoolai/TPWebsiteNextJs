    ...
    <div className="min-h-screen">
                  ...
                  <div className={`relative ${index % 2 === 1 ? 'lg:col-start-2' : ''}`}>
                    <div className="relative group">
                      ...
                      <div className={`absolute inset-0 rounded-2xl sm:rounded-3xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 -z-10 blur-2xl ${
                        card.accentColor === 'green' ? 'bg-gradient-to-r from-green-400 to-indigo-400' :
                        card.accentColor === 'green' ? 'bg-gradient-to-r from-green-400 to-emerald-400' :
                        card.accentColor === 'green' ? 'bg-gradient-to-r from-green-400 to-pink-400' :
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-lg border border-green-100">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_3fr] gap-8 sm:gap-12 items-center">
              ...
              <div className="text-center lg:text-center">
                ...
                <h1 className="text-1xl sm:text-2xl md:text-3xl text-lg mb-6">
                  <b>Industry Recognitions</b>
                </h1>
                <div className="flex justify-center items-center mb-8">
              <div className="bg-white rounded-full px-5 py-2 shadow-lg border border-gray-200 flex items-center space-x-2">
