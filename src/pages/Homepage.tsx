      ...
      <section className="pt-24 sm:pt-32 md:pt-40 pb-12 sm:pb-16 md:pb-20 relative min-h-screen flex items-center" style={{
        ...
        <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center animate-fade-in relative z-10">
            ...
            <div className="mb-6">
              <div className="inline-flex items-center bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-2 space-x-3 group hover:bg-white/15 transition-all duration-300">
                ...
                <button className="text-white/80 hover:text-white transition-colors text-xs font-medium flex items-center">
                  Learn more
